...
''')
    ...
    # Lab 3
    # =====================================================================
    python_package(root, "arc_lab3", "Lab 3: sensor diagnostics and recording",
                   ["rclpy", "sensor_msgs", "rosbag2_py"],
                   {"sensor_doctor": "arc_lab3.sensor_doctor:main"})

    write(root, "arc_lab3/arc_lab3/sensor_doctor.py", '''
#!/usr/bin/env python3
...
''')
    ...
    # Lab 5
    # =====================================================================
    python_package(root, "arc_lab5", "Lab 5: odometry drift measurement and SLAM bring-up",
                   ["rclpy", "nav_msgs", "geometry_msgs", "tf2_ros", "slam_toolbox"],
                   {"drift_meter": "arc_lab5.drift_meter:main"},
                   data_dirs=["launch"])

    write(root, "arc_lab5/arc_lab5/drift_meter.py", '''
#!/usr/bin/env python3
...
''')
    ...
    # Lab 4 and Lab 7
    # =====================================================================
    python_package(root, "arc_lab4", "Lab 4: reading recordings for occupancy mapping",
                   ["rclpy", "rosbag2_py", "sensor_msgs", "nav_msgs", "nav2_map_server"],
                   {"bag_reader": "arc_lab4.bag_reader:main"})

    write(root, "arc_lab4/arc_lab4/bag_reader.py", '''
#!/usr/bin/env python3
...
''')
    ...
    python_package(root, "arc_lab7", "Lab 7: deliberately difficult navigation scenarios",
                   ["rclpy", "navigation2", "nav2_bringup", "arc_nav", "arc_gazebo"],
                   {"fault_injector": "arc_lab7.fault_injector:main"},
                   data_dirs=["launch", "config"])

    write(root, "arc_lab7/arc_lab7/fault_injector.py", '''
#!/usr/bin/env python3
...
''')
    ...
    write(root, "arc_lab7/launch/difficult_robot.launch.py", '''
