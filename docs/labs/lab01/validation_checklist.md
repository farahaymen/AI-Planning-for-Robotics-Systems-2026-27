...
| V1.3 | `range_source` publishes at exactly 10 Hz | `ros2 topic hz /range` | |
...
|----|-------|--------|--------|
| V1.16 | Health check and Git setup | 10 min | |
| V1.17 | Exercise 1.1 for a median student | 20 min | |
| V1.18 | Exercise 1.2 | 20 min | |
| V1.19 | Exercises 1.3 and 1.4 | 25 min | |
| V1.20 | Whole session | 120 min | |

V1.17 is the risk. This is the students' first `colcon build` and first
