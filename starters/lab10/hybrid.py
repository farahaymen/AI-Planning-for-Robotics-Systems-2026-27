"""
Lab 10: a hybrid controller that switches between classical and learned.

The architecture follows the reasoning in Chandra et al. (2024): keep the
classical controller as the default because it is predictable and verifiable,
and hand over to a learned policy only in the situations the classical
controller demonstrably handles badly.
...
Both controllers consume the identical observation defined in arc_rl.nav_core,
so switching costs nothing at the interface.
"""
