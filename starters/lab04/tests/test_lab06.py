"""
Lab 4 self-check. Run this before you submit.
...
produce a wall of confusing errors.
    ...
    ARC_GRID_TOOLS=grid_tools_skeleton pytest starters/lab04/tests -v
"""
...
def test_points_just_below_origin_remain_outside_grid():
    _, info = G.occupancy_to_numpy(fake_occupancy())
    assert G.world_to_grid(info.origin_x - 0.01, info.origin_y, info) == (0, -1)
    assert G.world_to_grid(info.origin_x, info.origin_y - 0.01, info) == (-1, 0)
...
#     ARC_INTEGRATION=1 pytest starters/lab04/tests -v
