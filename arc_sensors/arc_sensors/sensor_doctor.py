...
# Sensor data is published best effort. A reliable subscription can discover
# the publisher but cannot form a compatible data connection; middleware may
# log an incompatibility warning. Lab 2 introduces this delivery setting.
