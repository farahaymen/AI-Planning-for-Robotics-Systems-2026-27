"""Simulation plus map server plus AMCL, for Lab 5's saved-map session.

    ros2 launch arc_localization localization.launch.py map:=$HOME/arc_ws/maps/slam_map.yaml
"""
